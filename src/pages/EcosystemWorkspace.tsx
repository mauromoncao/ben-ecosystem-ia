...
const AGENTS: Agent[] = [
  ...
  // ── Contador ─────────────────────────────────────────────────
  { id: 'ben-contador-tributarista',              shortName: 'Triagem',              name: 'BEN Contador — Triagem',              emoji: '🧮', description: 'Triagem fiscal + pesquisa legislação tributária em tempo real.',                          model: 'Claude Sonnet 4 + Perplexity',   category: 'contador', project: 'juris', color: '#92400e', accentColor: '#fef3c7' },
  ...
  { id: 'ben-analista-relatorios',    shortName: 'Relatórios',    name: 'BEN Analista de Relatórios',       emoji: '📈', description: 'Relatórios de performance + pesquisa em tempo real.',        model: 'Claude Sonnet 4 + Perplexity', category: 'marketing',   project: 'growth', color: '#d97706', accentColor: '#fef3c7' },
