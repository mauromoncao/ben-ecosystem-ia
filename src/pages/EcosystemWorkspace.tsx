...
const AGENTS: Agent[] = [
  // ── Jurídico ─────────────────────────────────────────────────
  { id: 'ben-agente-operacional-maximus',  shortName: 'Agente Maximus',        name: 'AGENTE OPERACIONAL MAXIMUS',          emoji: '⭐', description: 'Análise jurídica de máxima profundidade — última instância, análise final e vinculante.', model: 'BEN IA Pro',    category: 'juridico',    project: 'juris',  color: '#92400e', accentColor: '#fef3c7', premium: true },
  { id: 'ben-agente-operacional-premium',  shortName: 'Agente Premium',        name: 'AGENTE OPERACIONAL PREMIUM',          emoji: '🔷', description: 'Análise jurídica moderada a profunda. Thinking adaptativo automático. Sinaliza casos para o Maximus.', model: 'BEN IA Plus',  category: 'juridico', project: 'juris', color: '#1d4ed8', accentColor: '#dbeafe', premium: true },
  { id: 'ben-agente-operacional-standard', shortName: 'Agente Standard', name: 'AGENTE OPERACIONAL STANDARD', emoji: '🟢', description: 'Execução operacional. Extração, resumo, classificação, checklist. Thinking + Pesquisa em tempo real.', model: 'BEN IA Plus', category: 'juridico', project: 'juris', color: '#16a34a', accentColor: '#dcfce7', premium: false },
  { id: 'ben-tributarista-estrategista',   shortName: 'Tributarista Estrat.',  name: 'AGENTE TRIBUTARISTA ESTRATEGISTA',    emoji: '🔱', description: 'Especialista em Direito Tributário Puro. Thinking sempre ativo. Raciocínio em 7 camadas. Defesa no CARF, TJ, STJ e STF.', model: 'BEN IA Pro', category: 'juridico', project: 'juris', color: '#b45309', accentColor: '#fef3c7', premium: true },
  { id: 'ben-processualista-estrategico',  shortName: 'Processualista Estrat.',name: 'AGENTE PROCESSUALISTA ESTRATÉGICO',   emoji: '📋', description: 'Estrategista processual de nível STF/STJ. Thinking sempre ativo. Análise em 6 camadas. Pipeline RAG para PDFs.', model: 'BEN IA Pro', category: 'juridico', project: 'juris', color: '#1e3a5f', accentColor: '#dbeafe', premium: true },
  { id: 'ben-pesquisador-juridico',        shortName: 'Pesquisador',           name: 'BEN Pesquisador Jurídico',            emoji: '🔎', description: 'Pesquisa em tempo real: STF, STJ, TRF, TJPI com citações.',       model: 'BEN IA Search',       category: 'juridico',    project: 'juris',  color: '#6d28d9', accentColor: '#ede9fe' },
  // ── Contador ─────────────────────────────────────────────────
  { id: 'ben-contador-tributarista',              shortName: 'Triagem',              name: 'BEN Contador — Triagem',              emoji: '🧮', description: 'Triagem fiscal + pesquisa legislação tributária em tempo real.',                          model: 'BEN IA Plus',   category: 'contador', project: 'juris', color: '#92400e', accentColor: '#fef3c7' },
  { id: 'ben-contador-especialista',              shortName: 'Especialista',         name: 'BEN Contador — Especialista',         emoji: '📊', description: 'Análise fiscal profunda.',                  model: 'BEN IA Plus',  category: 'contador', project: 'juris', color: '#b45309', accentColor: '#fef9c3' },
  { id: 'ben-contador-planejamento',              shortName: 'Planejamento',         name: 'BEN Contador — Planejamento',         emoji: '🗺️', description: 'Planejamento tributário estratégico.',      model: 'BEN IA Plus',  category: 'contador', project: 'juris', color: '#d97706', accentColor: '#fef3c7' },
  { id: 'ben-contador-creditos',                  shortName: 'Créditos',             name: 'BEN Contador — Créditos',             emoji: '💳', description: 'Recuperação de créditos tributários.',      model: 'BEN IA Plus',  category: 'contador', project: 'juris', color: '#059669', accentColor: '#d1fae5' },
  { id: 'ben-contador-auditoria',                 shortName: 'Auditoria',            name: 'BEN Contador — Auditoria',            emoji: '🔍', description: 'Auditoria fiscal.',                         model: 'BEN IA Plus',  category: 'contador', project: 'juris', color: '#dc2626', accentColor: '#fee2e2' },
  { id: 'ben-contador-relatorio',                 shortName: 'Relatório',            name: 'BEN Contador — Relatório',            emoji: '📋', description: 'Relatórios fiscais.',                       model: 'BEN IA Plus',  category: 'contador', project: 'juris', color: '#0369a1', accentColor: '#e0f2fe' },
  { id: 'ben-contador-tributarista-planejamento', shortName: 'Trib. Planejamento',   name: 'BEN Contador Trib. — Planejamento',   emoji: '🗂️', description: 'Planejamento tributário nível 2.',          model: 'BEN IA Plus',  category: 'contador', project: 'juris', color: '#d97706', accentColor: '#fef3c7' },
  { id: 'ben-contador-tributarista-creditos',     shortName: 'Trib. Créditos',       name: 'BEN Contador Trib. — Créditos',       emoji: '💰', description: 'Créditos tributários nível 2.',             model: 'BEN IA Plus',  category: 'contador', project: 'juris', color: '#059669', accentColor: '#d1fae5' },
  { id: 'ben-contador-tributarista-auditoria',    shortName: 'Trib. Auditoria',      name: 'BEN Contador Trib. — Auditoria',      emoji: '🔎', description: 'Auditoria tributária nível 2.',             model: 'BEN IA Plus',  category: 'contador', project: 'juris', color: '#dc2626', accentColor: '#fee2e2' },
  { id: 'ben-contador-tributarista-relatorio',    shortName: 'Trib. Relatório',      name: 'BEN Contador Trib. — Relatório',      emoji: '📑', description: 'Relatório tributário nível 2.',             model: 'BEN IA Plus',  category: 'contador', project: 'juris', color: '#0369a1', accentColor: '#e0f2fe' },
  // ── Perito Forense ───────────────────────────────────────────
  { id: 'ben-perito-forense',          shortName: 'Padrão',        name: 'BEN Perito Forense — Padrão',     emoji: '🔬', description: 'Laudos periciais.',              model: 'BEN IA Plus',  category: 'perito', project: 'juris', color: '#4f46e5', accentColor: '#e0e7ff' },
  { id: 'ben-perito-forense-profundo', shortName: 'Profundo',      name: 'BEN Perito Forense — Profundo',   emoji: '🧬', description: 'Análise pericial profunda.',     model: 'BEN IA Pro',    category: 'perito', project: 'juris', color: '#b91c1c', accentColor: '#fee2e2', premium: true },
  { id: 'ben-perito-forense-digital',  shortName: 'Digital',       name: 'BEN Perito Forense Digital',      emoji: '💻', description: 'Perícia digital.',              model: 'BEN IA Plus',  category: 'perito', project: 'juris', color: '#7c3aed', accentColor: '#ede9fe' },
  { id: 'ben-perito-forense-laudo',    shortName: 'Laudo',         name: 'BEN Perito Forense — Laudo',      emoji: '📄', description: 'Laudos técnicos.',              model: 'BEN IA Plus',  category: 'perito', project: 'juris', color: '#0369a1', accentColor: '#e0f2fe' },
  { id: 'ben-perito-forense-contestar',shortName: 'Contraditório', name: 'BEN Perito — Contraditório',      emoji: '🛡️', description: 'Contestação de laudos.',        model: 'BEN IA Plus',  category: 'perito', project: 'juris', color: '#059669', accentColor: '#d1fae5' },
  { id: 'ben-perito-forense-relatorio',shortName: 'Relatório',     name: 'BEN Perito Forense — Relatório',  emoji: '📊', description: 'Relatórios periciais.',         model: 'BEN IA Plus',  category: 'perito', project: 'juris', color: '#374151', accentColor: '#f3f4f6' },
  { id: 'ben-perito-imobiliario',      shortName: 'Imobiliário',   name: 'BEN Perito Imobiliário — ABNT',   emoji: '🏠', description: 'Perícia imobiliária ABNT.',     model: 'BEN IA Plus',  category: 'perito', project: 'juris', color: '#78350f', accentColor: '#fef3c7' },
  // ── Growth & Marketing ───────────────────────────────────────
  { id: 'ben-atendente',              shortName: 'Atendente',     name: 'BEN Atendente',                    emoji: '🤝', description: 'Atendimento jurídico 24/7.',        model: 'BEN IA',      category: 'atendimento', project: 'growth', color: '#059669', accentColor: '#d1fae5' },
  { id: 'ben-conteudista',            shortName: 'Conteudista',   name: 'BEN Conteudista Jurídico',         emoji: '✍️', description: 'Artigos e conteúdo OAB.',           model: 'BEN IA Pro',           category: 'marketing',   project: 'growth', color: '#7c3aed', accentColor: '#ede9fe' },
  { id: 'ben-estrategista-campanhas', shortName: 'Campanhas',     name: 'BEN Estrategista Campanhas',       emoji: '📊', description: 'Meta Ads e Google Ads.',            model: 'BEN IA Pro',           category: 'marketing',   project: 'growth', color: '#059669', accentColor: '#d1fae5' },
  { id: 'ben-estrategista-marketing', shortName: 'Marketing',     name: 'BEN Estrategista Marketing',       emoji: '📣', description: 'Redes sociais e branding.',         model: 'BEN IA Pro',           category: 'marketing',   project: 'growth', color: '#0369a1', accentColor: '#e0f2fe' },
  { id: 'ben-analista-relatorios',    shortName: 'Relatórios',    name: 'BEN Analista de Relatórios',       emoji: '📈', description: 'Relatórios de performance + pesquisa em tempo real.',        model: 'BEN IA Plus', category: 'marketing',   project: 'growth', color: '#d97706', accentColor: '#fef3c7' },
  { id: 'ben-diretor-criativo',       shortName: 'Dir. Criativo', name: 'BEN Diretor Criativo',             emoji: '🎨', description: 'Branding jurídico.',                model: 'BEN IA Pro',           category: 'marketing',   project: 'growth', color: '#7c3aed', accentColor: '#ede9fe' },
  // ── Sistema ──────────────────────────────────────────────────
  { id: 'ben-assistente-geral',       shortName: 'BEN Copilot',      name: 'BEN Copilot — Universal',        emoji: '🤖', description: 'Copiloto universal BEN IA — sem restrições temáticas.',    model: 'BEN IA Pro',           category: 'sistema',     project: 'juris',  color: '#6d28d9', accentColor: '#ede9fe' },
  { id: 'ben-engenheiro-prompt',      shortName: 'Eng. Prompt',      name: 'BEN Engenheiro de Prompt',       emoji: '🧠', description: 'Otimização de prompts e arquitetura de agentes IA.',        model: 'BEN IA Pro',           category: 'sistema',     project: 'juris',  color: '#4f46e5', accentColor: '#e0e7ff' },
  { id: 'ben-analista-monitoramento', shortName: 'Monitoramento',    name: 'BEN Analista Monitoramento',     emoji: '🔍', description: 'Saúde do sistema e monitoramento de métricas.',            model: 'BEN IA', category: 'sistema',     project: 'juris',  color: '#dc2626', accentColor: '#fee2e2' },
  { id: 'ben-monitor-juridico',       shortName: 'Monitor Jurídico', name: 'BEN Monitor Jurídico DJe + CNJ', emoji: '📡', description: 'Monitoramento de publicações DJe e CNJ em tempo real.',   model: 'BEN IA Plus',  category: 'sistema',     project: 'juris',  color: '#0e7490', accentColor: '#cffafe' },
  { id: 'ben-assistente-cnj',         shortName: 'Assistente CNJ',   name: 'BEN Assistente CNJ DataJud',     emoji: '🔱', description: 'Consultas ao DataJud e CNJ com análise de movimentações.', model: 'BEN IA Plus',  category: 'sistema',     project: 'juris',  color: '#0e7490', accentColor: '#cffafe' },
  { id: 'ben-assistente-voz',         shortName: 'Assistente Voz',   name: 'BEN Assistente Voz — TTS',       emoji: '🎙️', description: 'Converte textos dos agentes em áudio via ElevenLabs.',     model: 'BEN IA',   category: 'sistema',     project: 'juris',  color: '#7c3aed', accentColor: '#ede9fe' },
]
          ...
          <div className="flex-shrink-0 pb-5 px-4">
            <div className="max-w-3xl mx-auto">
              ...
              <div className="flex items-center justify-center gap-3 mt-2 text-xs flex-wrap" style={{ color: '#9CA3AF' }}>
                ...
                {/* Motor IA oculto — BEN Copilot ativo como padrão */}
                {useSearch && (
