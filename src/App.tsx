...
const SIDEBAR_CATEGORIES: AgentCategory[] = [
  {
    ...
    agents: [
      { id: 'ben-agente-operacional-maximus',           emoji: '⭐', shortName: 'Agente Maximus',         name: 'AGENTE OPERACIONAL MAXIMUS',       model: 'BEN IA Pro',   badge: 'PRO',   badgeColor: '#92400e' },
      { id: 'ben-agente-operacional-premium',      emoji: '🔷', shortName: 'Agente Premium',         name: 'AGENTE OPERACIONAL PREMIUM',       model: 'BEN IA Plus', badge: 'PLUS', badgeColor: '#1d4ed8' },
      { id: 'ben-agente-operacional-standard',     emoji: '🟢', shortName: 'Agente Standard',        name: 'AGENTE OPERACIONAL STANDARD',      model: 'BEN IA',  badge: 'STD',  badgeColor: '#16a34a' },
      { id: 'ben-tributarista-estrategista',       emoji: '🔱', shortName: 'Tributarista Estrat.',   name: 'AGENTE TRIBUTARISTA ESTRATEGISTA', model: 'BEN IA Pro',   badge: 'PRO',   badgeColor: '#b45309' },
      { id: 'ben-processualista-estrategico',      emoji: '📋', shortName: 'Processualista Estrat.', name: 'AGENTE PROCESSUALISTA ESTRATÉGICO',model: 'BEN IA Pro',   badge: 'PRO',   badgeColor: '#1e3a5f' },
      { id: 'ben-pesquisador-juridico',            emoji: '🔎', shortName: 'Pesquisador',            name: 'BEN Pesquisador Jurídico',         model: 'BEN IA Search' },
    ],
  },
  {
    key: 'contador', label: 'Contador', icon: <BarChart3 className="w-3.5 h-3.5" />, color: '#FCD34D',
    agents: [
      { id: 'ben-contador-tributarista',              emoji: '🧮', shortName: 'Triagem',         name: 'BEN Contador — Triagem',         model: 'BEN IA',  badge: 'STD',  badgeColor: '#16a34a' },
      { id: 'ben-contador-especialista',              emoji: '📊', shortName: 'Especialista',    name: 'BEN Contador — Especialista',    model: 'BEN IA Plus', badge: 'PLUS', badgeColor: '#1d4ed8' },
      { id: 'ben-contador-planejamento',              emoji: '🗺️', shortName: 'Planejamento',    name: 'BEN Contador — Planejamento',    model: 'BEN IA Plus', badge: 'PLUS', badgeColor: '#1d4ed8' },
      { id: 'ben-contador-creditos',                  emoji: '💳', shortName: 'Créditos',        name: 'BEN Contador — Créditos',        model: 'BEN IA Plus', badge: 'PLUS', badgeColor: '#1d4ed8' },
      { id: 'ben-contador-auditoria',                 emoji: '🔍', shortName: 'Auditoria',       name: 'BEN Contador — Auditoria',       model: 'BEN IA Plus', badge: 'PLUS', badgeColor: '#1d4ed8' },
      { id: 'ben-contador-relatorio',                 emoji: '📋', shortName: 'Relatório',       name: 'BEN Contador — Relatório',       model: 'BEN IA Plus', badge: 'PLUS', badgeColor: '#1d4ed8' },
      { id: 'ben-contador-tributarista-planejamento', emoji: '🗂️', shortName: 'Trib. Planej.',   name: 'BEN Contador Trib. — Planejamento', model: 'BEN IA Plus', badge: 'PLUS', badgeColor: '#1d4ed8' },
      { id: 'ben-contador-tributarista-creditos',     emoji: '💰', shortName: 'Trib. Créditos',  name: 'BEN Contador Trib. — Créditos',  model: 'BEN IA Plus', badge: 'PLUS', badgeColor: '#1d4ed8' },
      { id: 'ben-contador-tributarista-auditoria',    emoji: '🔎', shortName: 'Trib. Auditoria', name: 'BEN Contador Trib. — Auditoria', model: 'BEN IA Plus', badge: 'PLUS', badgeColor: '#1d4ed8' },
      { id: 'ben-contador-tributarista-relatorio',    emoji: '📑', shortName: 'Trib. Relatório', name: 'BEN Contador Trib. — Relatório', model: 'BEN IA Plus', badge: 'PLUS', badgeColor: '#1d4ed8' },
    ],
  },
  {
    key: 'perito', label: 'Perito Forense', icon: <FlaskConical className="w-3.5 h-3.5" />, color: '#C4B5FD',
    agents: [
      { id: 'ben-perito-forense',           emoji: '🔬', shortName: 'Padrão',        name: 'BEN Perito Forense — Padrão',     model: 'BEN IA Plus', badge: 'PLUS', badgeColor: '#1d4ed8' },
      { id: 'ben-perito-forense-profundo',  emoji: '🧬', shortName: 'Profundo',       name: 'BEN Perito Forense — Profundo',   model: 'BEN IA Pro',   badge: 'PRO',   badgeColor: '#b45309' },
      { id: 'ben-perito-forense-digital',   emoji: '💻', shortName: 'Digital',        name: 'BEN Perito Forense Digital',      model: 'BEN IA Plus', badge: 'PLUS', badgeColor: '#1d4ed8' },
      { id: 'ben-perito-forense-laudo',     emoji: '📄', shortName: 'Laudo',          name: 'BEN Perito Forense — Laudo',      model: 'BEN IA Plus', badge: 'PLUS', badgeColor: '#1d4ed8' },
      { id: 'ben-perito-forense-contestar', emoji: '🛡️', shortName: 'Contraditório',  name: 'BEN Perito — Contraditório',      model: 'BEN IA Plus', badge: 'PLUS', badgeColor: '#1d4ed8' },
      { id: 'ben-perito-forense-relatorio', emoji: '📊', shortName: 'Relatório',      name: 'BEN Perito Forense — Relatório',  model: 'BEN IA Plus', badge: 'PLUS', badgeColor: '#1d4ed8' },
      { id: 'ben-perito-imobiliario',       emoji: '🏠', shortName: 'Imobiliário',    name: 'BEN Perito Imobiliário — ABNT',   model: 'BEN IA Plus', badge: 'PLUS', badgeColor: '#1d4ed8' },
    ],
  },
  {
    key: 'growth', label: 'Growth & Marketing', icon: <Megaphone className="w-3.5 h-3.5" />, color: '#6EE7B7',
    agents: [
      { id: 'ben-atendente',              emoji: '🤝', shortName: 'Atendente',     name: 'BEN Atendente',               model: 'BEN IA' },
      { id: 'ben-conteudista',            emoji: '✍️', shortName: 'Conteudista',   name: 'BEN Conteudista Jurídico',    model: 'BEN IA Pro' },
      { id: 'ben-estrategista-campanhas', emoji: '📊', shortName: 'Campanhas',     name: 'BEN Estrategista Campanhas',  model: 'BEN IA Pro' },
      { id: 'ben-estrategista-marketing', emoji: '📣', shortName: 'Marketing',     name: 'BEN Estrategista Marketing',  model: 'BEN IA Pro' },
      { id: 'ben-analista-relatorios',    emoji: '📈', shortName: 'Relatórios',    name: 'BEN Analista de Relatórios',  model: 'BEN IA' },
      { id: 'ben-diretor-criativo',       emoji: '🎨', shortName: 'Dir. Criativo', name: 'BEN Diretor Criativo',        model: 'BEN IA Pro' },
    ],
  },
  {
    key: 'sistema', label: 'Sistema', icon: <Cpu className="w-3.5 h-3.5" />, color: '#A5B4FC',
    agents: [
      { id: 'ben-assistente-geral',       emoji: '✨', shortName: 'BEN Copilot',       name: 'BEN Copilot — Universal',        model: 'BEN IA Pro',          badge: 'FIXO',   badgeColor: '#6d28d9' },
      { id: 'ben-engenheiro-prompt',      emoji: '🧠', shortName: 'Eng. Prompt',       name: 'BEN Engenheiro de Prompt',       model: 'BEN IA Pro' },
      { id: 'ben-analista-monitoramento', emoji: '🔍', shortName: 'Monitoramento',     name: 'BEN Analista Monitoramento',     model: 'BEN IA' },
      { id: 'ben-monitor-juridico',       emoji: '📡', shortName: 'Monitor Jurídico',  name: 'BEN Monitor Jurídico DJe + CNJ', model: 'BEN IA Plus', badge: 'NEW',    badgeColor: '#0e7490' },
      { id: 'ben-assistente-cnj',         emoji: '🔱', shortName: 'Assistente CNJ',    name: 'BEN Assistente CNJ DataJud',     model: 'BEN IA Plus', badge: 'NEW',    badgeColor: '#0e7490' },
      { id: 'ben-assistente-voz',         emoji: '🎙️', shortName: 'Assistente Voz',    name: 'BEN Assistente Voz — TTS',       model: 'BEN IA' },
    ],
  },
]
